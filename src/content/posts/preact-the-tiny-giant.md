...
**🏗️ Incremental React migration** — Existing React codebase you can't fully rewrite? Drop in Preact/compat, win back performance budget, spend it on something useful like lazy loading your enormous chart library.
...
Preact's team is currently working on version 11 (beta 1 at the time of writing), which adds some necessary features and optimisations to keep up with he big brother. I am really curious to see how the new version will perform in real world applications, and if it will be able to maintain its tiny size while adding new features.
